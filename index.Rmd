...
load(here("./ignacymorawski.github.io/data/wse.RData"))
load(here("./ignacymorawski.github.io/data/nc.RData"))
...
save(ws1,ws2,file=here("./ignacymorawski.github.io/data/wse.RData"))
}
...
for (i in seq(length(lnce2))){
  ...
  download.file(paste0("https://newconnect.pl/pub/NEWCONNECT/statystyki/statystyki_dzienne/NC_",lnce3[i],".xls"),
                destfile=here(paste0("./ignacymorawski.github.io/data/ncq/NC_",lnce3[i],".xls")),mode="wb")
    
  
  u0<-read_excel(here(paste0("./ignacymorawski.github.io/data/ncq/NC_",lnce3[i],".xls")),3,skip=5,col_names = TRUE)
...
save(nc1,nc2,file=here("./ignacymorawski.github.io/data/nc.RData"))
}

#ind[7,2]<-"WIG.GAMES5"

load(here("./ignacymorawski.github.io/data/sector.RData"))
...
save(ind,sector,file=here("./ignacymorawski.github.io/data/sector.RData"))
}
...
cat(paste0("- Ostatnia aktualizacja: ",Sys.time()+3600))
```
...
bp<-ggplot(p1,aes(x=date,y=Value))+
  ...
  scale_x_date(breaks=c(p1$date[1],p1$date[51]),labels=c(p1$date[1],p1$date[51]))
